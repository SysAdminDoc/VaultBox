...
*/ "use strict";
  ...
  !(function () {
    ...
    var autofill_inline_menu_button_awaiter =
      (undefined && undefined.__awaiter) ||
      function (thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P
    ...
    class AutofillInlineMenuButton extends AutofillInlineMenuPageElement {
      ...
      initAutofillInlineMenuButton(_a) {
        return autofill_inline_menu_button_awaiter(
          this,
          arguments,
          void 0,
          function* ({ authStatus, styleSheetUrl, translations, portKey }) {
      ...
      isButtonHovered() {
        ...
        const hoveredElement =
          (_a = this.buttonElement) === null || _a === void 0 ? void 0 : _a.querySelector(":hover");
        return !!(
          hoveredElement &&
