...
*/ "use strict";
            ...
            if (f.nodeType === Node.ELEMENT_NODE) {
              ...
              if ("link" === e && "import" === c.getAttribute("rel")) {
                ...
                if (f instanceof Node && !d.has(f))
                  for (d.add(f), f = f.firstChild; f; f = f.nextSibling) M(f, b, d);
                f = L(a, c);
                continue;
              } else if ("template" === e) {
                f = L(a, c);
        ...
        function X(a) {
          ...
          void 0 === ErrorEvent.prototype.initErrorEvent
            ...
            : ((e = document.createEvent("ErrorEvent")),
              e.initErrorEvent("error", !1, !0, b, d, f),
        ...
        xa.prototype.G = function (a) {
          ...
          for (b = 0; b < a.length; b++)
            for (var d = a[b].addedNodes, f = 0; f < d.length; f++) V(this.h, d[f]);
        };
        function Y(a) {
          this.s = new Map();
          this.u = new Map();
        ...
        (O && !O.forcePolyfill && "function" == typeof O.define && "function" == typeof O.get) ||
          Ia();
  ...
  !(function () {
    "use strict"; // ./src/autofill/enums/autofill-overlay.enum.ts
    ...
    var custom_elements_min = __webpack_require__(70526); // ../../node_modules/lit/polyfill-support.js
    !(function (i) {
       ...
       */ var i,
        n,
        o = "__scoped";
      (null !== (i = globalThis.reactiveElementPolyfillSupport) && void 0 !== i) ||
        (globalThis.reactiveElementPolyfillSupport = function (i) {
          ...
          if (
            ...
            window.ShadyDOM &&
              ...
              window.ShadyDOM.patchElementProto(t);
            ...
            t.createRenderRoot = function () {
              ...
              if (!this.constructor.hasOwnProperty(o)) {
                ...
                var v = this.constructor.elementStyles.map(function (i) {
                  return i instanceof CSSStyleSheet
                    ? Array.from(i.cssRules).reduce(function (i, n) {
                        return i + n.cssText;
                      }, "")
                    : i.cssText;
                });
                (null ===
                  (n = null === (i = window.ShadyCSS) || void 0 === i ? void 0 : i.ScopingShim) ||
                  void 0 === n ||
                  n.prepareAdoptedCssText(v, w),
                  void 0 === this.constructor._$AJ &&
                    window.ShadyCSS.prepareTemplateStyles(document.createElement("template"), w));
              }
      ...
      var t,
        d = new Set(),
        w = new Map();
      ((null !== (n = globalThis.litHtmlPolyfillSupport) && void 0 !== n) ||
        (globalThis.litHtmlPolyfillSupport = function (i, n) {
          if (
            void 0 !== window.ShadyCSS &&
            (!window.ShadyCSS.nativeShadow || window.ShadyCSS.ApplyShim)
          ) {
            ...
            i.createElement = function (n, d) {
              ...
              if (
                void 0 !== v &&
                (window.ShadyCSS.nativeShadow || window.ShadyCSS.prepareTemplateDom(w, v), o(v))
              ) {
                var r = t(v),
                  u = w.content.querySelectorAll("style");
                r.push.apply(
                  r,
                  Array.from(u).map(function (i) {
                    var n;
                    return (
                      null === (n = i.parentNode) || void 0 === n || n.removeChild(i),
                      i.textContent
                    );
                  }),
                );
            ...
            ((s._$AI = function (i, n) {
              ...
              if (s instanceof ShadowRoot && o(a)) {
                ...
                var c = (null == i ? void 0 : i._$litType$)
                  ? this._$AH._$AD.el
                ...
                if (
                  ((function (i, n) {
                    var o,
                      ...
                      l = 0 !== v.length;
                    (l &&
                      (((o = document.createElement("style")).textContent = v.join("\n")),
                  ...
                  r.removeChild(u),
                  null === (l = window.ShadyCSS) || void 0 === l ? void 0 : l.nativeShadow)
                ) {
        ...
        (null !== (t = globalThis.litElementPolyfillSupport) && void 0 !== t) ||
          (globalThis.litElementPolyfillSupport = function (i) {
            var n = i.LitElement;
            if (
              void 0 !== window.ShadyCSS &&
              (!window.ShadyCSS.nativeShadow || window.ShadyCSS.ApplyShim)
    ...
    })(AuthenticationStatus || (AuthenticationStatus = {})); // ../../libs/common/src/autofill/constants/match-patterns.ts
    ...
    const MAX_DEEP_QUERY_RECURSION_DEPTH = 4; // ../../libs/common/src/vault/enums/cipher-reprompt-type.ts
     ...
     */
    const cipherTypeNames = Object.freeze(
    ...
    function currentlyInSandboxedIframe() {
      ...
      const sandbox =
        (_b =
          (_a = globalThis.frameElement) === null || _a === void 0 ? void 0 : _a.getAttribute) ===
          null || _b === void 0
          ? void 0
          : _b.call(_a, "sandbox");
    ...
    class AutofillInlineMenuPageElement extends HTMLElement {
      ...
      postMessageToParent(message) {
        ...
        const messageWithAuth = Object.assign(Object.assign({ portKey: this.portKey }, message), {
          token: this.token,
        });
    ...
    var autofill_inline_menu_list_awaiter =
      (undefined && undefined.__awaiter) ||
      function (thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P
    ...
    class AutofillInlineMenuList extends AutofillInlineMenuPageElement {
      constructor() {
        ...
        this.handleFillGeneratedPasswordKeyUp = (event) => {
          ...
          if (
            ...
            (_a = event.target.parentElement) === null || _a === void 0
              ? void 0
              : _a.classList.add("remove-outline");
            return;
          }
        };
        /**
        ...
        this.handleRefreshGeneratedPasswordClick = (event) => {
          ...
          if (event) {
            (_a = event.target.closest(".password-generator-actions")) === null || _a === void 0
              ? void 0
              : _a.classList.add("remove-outline");
          }
        ...
        this.handleRefreshGeneratedPasswordKeyUp = (event) => {
          ...
          if (
            ...
            (_a = event.target.parentElement) === null || _a === void 0
              ? void 0
              : _a.classList.remove("remove-outline");
            return;
          }
        };
        /**
        ...
        this.handleFillCipherClickEvent = (cipher) => {
          var _a;
          const usePasskey = !!((_a = cipher.login) === null || _a === void 0
            ? void 0
            : _a.passkey);
        ...
        this.handleNewItemButtonKeyUpEvent = (event) => {
          ...
          if (event.code === "ArrowDown") {
            const firstFillButton =
              (_a = this.ciphersList.firstElementChild) === null || _a === void 0
                ? void 0
                : _a.querySelector(".fill-cipher-button");
            firstFillButton === null || firstFillButton === void 0
              ? void 0
              : firstFillButton.focus();
            return;
          }
          const lastFillButton =
            (_b = this.ciphersList.lastElementChild) === null || _b === void 0
              ? void 0
              : _b.querySelector(".fill-cipher-button");
        ...
        this.handleViewCipherKeyUpEvent = (event) => {
          ...
          cipherContainer === null || cipherContainer === void 0
            ? void 0
        ...
        this.isListHovered = () => {
          ...
          const hoveredElement =
            (_a = this.inlineMenuListContainer) === null || _a === void 0
              ? void 0
              : _a.querySelector(":hover");
          return !!(
            hoveredElement &&
        ...
        this.toggleScrollClass = (height) => {
          ...
          if (!containerHeight) {
            const inlineMenuListContainerRects =
              this.inlineMenuListContainer.getBoundingClientRect();
        ...
        this.useEventHandlersMemo = (eventHandler, memoIndex) => {
          return (
            this.eventHandlersMemo[memoIndex] || (this.eventHandlersMemo[memoIndex] = eventHandler)
          );
        };
        /**
      ...
      initAutofillInlineMenuList(message) {
        return autofill_inline_menu_list_awaiter(this, void 0, void 0, function* () {
          ...
          const linkElement = yield this.initAutofillInlineMenuPage(
            "list",
            styleSheetUrl,
            translations,
            portKey,
      ...
      buildPasswordGenerator(generatedPassword) {
        ...
        passwordGeneratorActions.append(
          fillGeneratedPasswordButton,
          refreshGeneratedPasswordButton,
        );
      ...
      handleUpdateAutofillInlineMenuGeneratedPassword(message) {
        ...
        const colorizedPasswordElement =
          passwordGeneratorContentElement === null || passwordGeneratorContentElement === void 0
            ? void 0
      ...
      getFilteredCiphersForTotpField(ciphers) {
        ...
        const isTotpField =
          ...
          ciphers.some((cipher) => {
            var _a;
            return (_a = cipher.login) === null || _a === void 0 ? void 0 : _a.totpField;
          });
        if (isTotpField) {
          return ciphers.filter((cipher) => {
            var _a;
            return (_a = cipher.login) === null || _a === void 0 ? void 0 : _a.totp;
          });
        }
        return ciphers;
      }
      ...
      updateListItems({ ciphers = [], showInlineMenuAccountCreation = false }) {
        ...
        this.newItemButtonElement.addEventListener(
          EVENTS.KEYUP,
          this.handleNewItemButtonKeyUpEvent,
        );
      }
      /**
      ...
      loadPageOfCiphers() {
        ...
        for (let cipherIndex = this.currentCipherIndex; cipherIndex < lastIndex; cipherIndex++) {
          this.ciphersList.appendChild(
            this.buildInlineMenuListActionsItem(this.ciphers[cipherIndex]),
          );
      ...
      togglePasskeysHeadingAnchored(cipherListScrollTop) {
        ...
        const passkeysHeadingOffset =
          this.lastPasskeysListItem.offsetTop - this.passkeysHeadingHeight;
      ...
      toggleLoginHeadingBorder(cipherListScrollTop) {
        ...
        const lastPasskeyOffset =
          this.lastPasskeysListItem.offsetTop + this.lastPasskeysListItemHeight;
      ...
      buildInlineMenuListActionsItem(cipher) {
        ...
        if (
          ...
          ((_a = cipher.login) === null || _a === void 0 ? void 0 : _a.passkey)
        ) {
      ...
      buildFillCipherElement(cipher) {
        ...
        fillCipherElement.append(
          cipherIcon,
          ...(cipherDetailsElement ? [cipherDetailsElement] : []),
        );
      ...
      addFillCipherElementAriaDescription(fillCipherElement, cipher) {
        ...
        if (cipher.login) {
          const passkeyUserName =
            ((_a = cipher.login.passkey) === null || _a === void 0 ? void 0 : _a.userName) || "";
          const username = cipher.login.username || passkeyUserName;
          if (username) {
            fillCipherElement.setAttribute(
              "aria-description",
              `${(_b = this.getTranslation("username")) === null || _b === void 0 ? void 0 : _b.toLowerCase()}: ${username}`,
            );
          }
          return;
        }
        if (cipher.card) {
          ...
          if (cardParts.length === 1) {
            const cardDigits = cardParts[0].startsWith("*")
              ? cardParts[0].substring(1)
              : cardParts[0];
            fillCipherElement.setAttribute(
              "aria-description",
      ...
      buildCipherIconElement(cipher) {
        ...
        if (
          ((_a = cipher.login) === null || _a === void 0 ? void 0 : _a.totpField) &&
          ((_b = cipher.login) === null || _b === void 0 ? void 0 : _b.totp)
        ) {
    ...
    `);
          ...
          const intervalSeconds =
            (_c = cipher.login.totpCodeTimeInterval) !== null && _c !== void 0 ? _c : 30;
      ...
      buildCipherDetailsElement(cipher) {
        ...
        if (
          ((_b = cipher.login) === null || _b === void 0 ? void 0 : _b.totpField) &&
          ((_c = cipher.login) === null || _c === void 0 ? void 0 : _c.totp)
        ) {
          return this.buildTotpElement(
            (_d = cipher.login) === null || _d === void 0 ? void 0 : _d.totp,
      ...
      focusInlineMenuList() {
        ...
        firstListElement === null || firstListElement === void 0
          ? void 0
      ...
      focusNextListItem(currentListItem) {
        ...
        const nextSibling =
          nextListItem === null || nextListItem === void 0
            ? void 0
            : nextListItem.querySelector(".inline-menu-list-action");
        if (nextSibling) {
          nextSibling.focus();
          return;
        }
        ...
        let firstListItem =
          (_a = currentListItem.parentElement) === null || _a === void 0 ? void 0 : _a.firstChild;
        if (this.listItemIsHeadingElement(firstListItem)) {
          firstListItem = firstListItem.nextSibling;
        }
        const firstSibling =
          firstListItem === null || firstListItem === void 0
            ? void 0
            : firstListItem.querySelector(".inline-menu-list-action");
      ...
      focusPreviousListItem(currentListItem) {
        ...
        const previousSibling =
          previousListItem === null || previousListItem === void 0
            ? void 0
            : previousListItem.querySelector(".inline-menu-list-action");
        if (previousSibling) {
        ...
        const lastListItem =
          (_a = currentListItem.parentElement) === null || _a === void 0 ? void 0 : _a.lastChild;
        const lastSibling =
          lastListItem === null || lastListItem === void 0
            ? void 0
            : lastListItem.querySelector(".inline-menu-list-action");
