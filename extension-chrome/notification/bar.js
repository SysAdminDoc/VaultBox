/******/ (function () {
  // webpackBootstrap
  /******/ "use strict"; // ../../node_modules/@lit/reactive-element/css-tag.js
  ...
  class n {
    ...
    get styleSheet() {
      ...
      if (e && void 0 === t) {
        ...
        (e && (t = o.get(s)),
          void 0 === t &&
            ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o.set(s, t)));
      }
      return t;
    }
    toString() {
    ...
    c = e
      ...
      : (t) =>
          t instanceof CSSStyleSheet
            ...
            : t; // ../../node_modules/@lit/reactive-element/reactive-element.js
  /**
   * @license
   ...
   */ const {
      ...
      getOwnPropertyNames: reactive_element_r,
    ...
    b = { attribute: !0, type: String, converter: u, reflect: !1, useDefault: !1, hasChanged: f };
  ...
  class y extends HTMLElement {
    ...
    static createProperty(t, s = b) {
      if (
        ...
        void 0 !== h && reactive_element_e(this.prototype, t, h);
      }
    }
    ...
    static finalize() {
      ...
      if (((this.finalized = !0), this._$Ei(), this.hasOwnProperty(d("properties")))) {
        const t = this.properties,
          s = [...reactive_element_r(t), ...reactive_element_o(t)];
  ...
  ((y.elementStyles = []),
    ...
    p?.({ ReactiveElement: y }),
    (a.reactiveElementVersions ??= []).push("2.1.0")); // ../../node_modules/lit-html/lit-html.js
  /**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ const lit_html_t = globalThis,
    ...
    _ = />/g,
    m = RegExp(
      `>|${lit_html_d}(?:([^\\s"'>=/]+)(${lit_html_d}*=${lit_html_d}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,
      "g",
    ),
    lit_html_p = /'/g,
    g = /"/g,
    ...
    for (let i = 0; i < s; i++) {
              ...
              ? ">" === u[0]
                ...
                : void 0 === u[1]
                  ...
                  : ((d = c.lastIndex - u[2].length),
                    (a = u[1]),
                    (c = void 0 === u[3] ? m : '"' === u[3] ? g : lit_html_p))
              : c === g || c === lit_html_p
                ? (c = m)
                : c === v || c === _
                  ? (c = lit_html_f)
      ...
      l +=
        c === lit_html_f
          ? s + lit_html_n
          : d >= 0
            ? (o.push(a), s.slice(0, d) + lit_html_e + s.slice(d) + lit_html_h + x)
          ...
          if (r.hasAttributes())
            for (const t of r.getAttributeNames())
              if (t.endsWith(lit_html_e)) {
                ...
                t.startsWith(lit_html_h) && (d.push({ type: 6, index: c }), r.removeAttribute(t));
          if ($.test(r.tagName)) {
            ...
            if (s > 0) {
              ...
              for (let i = 0; i < s; i++)
                (r.append(t[i], lit_html_l()), C.nextNode(), d.push({ type: 2, index: ++c }));
  ...
  function lit_html_S(t, i, s = t, e) {
    ...
    return (
      ...
      void 0 !== h && (i = lit_html_S(t, h._$AS(t, i.values), h, e)),
      i
    );
  }
  class M {
  ...
  class R {
    ...
    _(t) {
      (this._$AH !== E && lit_html_c(this._$AH)
    ...
    k(t) {
      ...
      for (const h of t)
        (e === i.length
          ? i.push((s = new R(this.O(lit_html_l()), this.O(lit_html_l()), this, this.options)))
          : (s = i[e]),
          s._$AI(h),
          e++);
  ...
  class k {
    ...
    _$AI(t, i = this, s, e) {
      ...
      let o = !1;
      if (void 0 === h)
        ((t = lit_html_S(this, t, i, 0)),
          (o = !lit_html_c(t) || (t !== this._$AH && t !== T)),
          o && (this._$AH = t));
      else {
        const e = t;
        let n, r;
        for (t = h[0], n = 0; n < h.length - 1; n++)
          ((r = lit_html_S(this, e[s + n], i, n)),
            r === T && (r = this._$AH[n]),
  ...
  (j?.(N, R), (lit_html_t.litHtmlVersions ??= []).push("3.3.0"));
  const B = (t, i, s) => {
  ...
  ((lit_element_i._$litElement$ = !0),
    (lit_element_i["finalized"] = !0),
    lit_element_s.litElementHydrateSupport?.({ LitElement: lit_element_i }));
  const lit_element_o = lit_element_s.litElementPolyfillSupport;
  lit_element_o?.({ LitElement: lit_element_i });
  const lit_element_n = {
    _$AK: (t, e, r) => {
      t._$AK(e, r);
    },
  ...
  (lit_element_s.litElementVersions ??= []).push("4.2.0"); // ../../node_modules/lit/index.js
  ...
  (function (EncryptionType) {
    ...
    EncryptionType[(EncryptionType["Rsa2048_OaepSha256_HmacSha256_B64"] = 5)] =
      "Rsa2048_OaepSha256_HmacSha256_B64";
    EncryptionType[(EncryptionType["Rsa2048_OaepSha1_HmacSha256_B64"] = 6)] =
  ...
  })(FileUploadType || (FileUploadType = {})); // ../../libs/common/src/platform/enums/hash-purpose.enum.ts
  ...
  })(HashPurpose || (HashPurpose = {})); // ../../libs/storage-core/src/html-storage-location.enum.ts
  ...
  })(HtmlStorageLocation || (HtmlStorageLocation = {})); // ../../node_modules/tslib/tslib.es6.mjs
...
***************************************************************************** */ /* global Reflect, Promise, SuppressedError, Symbol, Iterator */ var extendStatics =
  ...
  function noop() {} // ../../node_modules/rxjs/dist/esm5/internal/NotificationFactories.js
  ...
  var EMPTY_OBSERVER = { closed: true, next: noop, error: defaultErrorHandler, complete: noop }; // ../../node_modules/rxjs/dist/esm5/internal/symbol/observable.js
  ...
  })(Subject); // ../../libs/storage-core/src/storage.service.ts
  class StorageService {} // ../../libs/storage-core/src/memory-storage.service.ts

  var memory_storage_service_awaiter =
  ...
  var serialized_memory_storage_service_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  })(StorageLocationEnum || (StorageLocationEnum = {})); // ../../libs/storage-core/src/index.ts
  ...
  })(KeySuffixOptions || (KeySuffixOptions = {})); // ../../libs/logging/src/log-level.ts
  ...
  })(log_level_LogLevel || (log_level_LogLevel = {})); // ../../libs/logging/src/console-log.service.ts
...
*/ function sheetForTag(tag) {
   ...
   */ function token(type) {
    switch (
      ...
      case 123:
      case 125:
        return 4; // : accompanied token
      case 58:
        return 3; // " ' ( [ opening delimit token
      case 34:
      case 39:
      case 40:
      case 91:
        return 2; // ) ] closing delimit token
      case 41:
      case 93:
        return 1;
    }
  ...
  var LAYER = "@layer"; // ../../node_modules/stylis/src/Serializer.js
  /**
          ...
          case RULESET:
            if (element.length)
              return combine(element.props, function (value) {
                switch (
                  match(value, /(::plac\w+|:read-\w+)/) // :read-(only|write)
                ) {
                  case ":read-only":
                  case ":read-write":
                    return serialize(
        ...
        element.props = element.props.map(function (value) {
          return combine(tokenize(value), function (value, index, children) {
            switch (
              ...
              case 12:
                return substr(value, 1, strlen(value)); // \0 ( + > ~
              case 0:
              case 40:
              case 43:
              case 62:
              ...
              case 58:
                if (children[++index] === "global")
                  ((children[index] = ""),
                    (children[++index] = "\f" + substr(children[index], (index = 1), -1))); // \s
              case 32:
      ...
      switch (
        ...
        case 40:
          if (previous != 108 && Utility_charat(characters, length - 1) == 58) {
            if (
              indexof((characters += Utility_replace(delimit(character), "&", "&\f")), "&\f") != -1
            )
              ampersand = -1;
            break;
          } // " ' [
        ...
        case 47:
          ...
          break; // {
        case 123 * variable:
          points[index++] = Utility_strlen(characters) * ampersand; // } ; \0
        case 125 * variable:
        case 59:
        case 0:
          switch (
            ...
            default:
              ...
              if (character === 123)
                if (offset === 0)
                  ...
                  switch (
                    atrule === 99 && Utility_charat(characters, 3) === 110 ? 100 : atrule // d l m s
                  ) {
                    case 100:
                    case 108:
                    case 109:
   ...
   */ function ruleset(
    ...
    for (var i = 0, j = 0, k = 0; i < index; ++i)
      for (
        var x = 0, y = Utility_substr(value, post + 1, (post = abs((j = points[i])))), z = value;
        x < size;
        ++x
      )
  ...
  /* eslint-disable no-fallthrough */ function emotion_cache_browser_esm_prefix(value, length) {
    switch (
      hash(value, length) // color-adjust
    ) {
      case 5103:
        return Enum_WEBKIT + "print-" + value + value; // animation, animation-(delay|direction|duration|fill-mode|iteration-count|name|play-state|timing-function)
      case 5737:
      case 4201:
      case 3177:
      case 3433:
      ...
      case 5621:
      case 3829:
        return Enum_WEBKIT + value + value; // appearance, user-select, transform, hyphens, text-size-adjust
      case 5349:
      case 4246:
      case 4810:
      case 6968:
      case 2756:
        return Enum_WEBKIT + value + Enum_MOZ + value + Enum_MS + value + value; // flex, flex-direction
      case 6828:
      case 4268:
        return Enum_WEBKIT + value + Enum_MS + value + value; // order
      case 6165:
        return Enum_WEBKIT + value + Enum_MS + "flex-" + value + value; // align-items
      case 5187:
        return (
          Enum_WEBKIT +
          value +
      ...
      case 5548:
        return Enum_WEBKIT + value + Enum_MS + Utility_replace(value, "shrink", "negative") + value; // flex-basis
      case 5292:
        return (
          Enum_WEBKIT + value + Enum_MS + Utility_replace(value, "basis", "preferred-size") + value
        ); // flex-grow
      case 6060:
        return (
          Enum_WEBKIT +
      ...
      case 4554:
        return (
          Enum_WEBKIT +
          Utility_replace(value, /([^-])(transform)/g, "$1" + Enum_WEBKIT + "$2") +
          value
        ); // cursor
      case 6187:
        return (
      ...
      case 5495:
      case 3959:
        return Utility_replace(value, /(image-set\([^]*)/, Enum_WEBKIT + "$1" + "$`$1"); // justify-content
      case 4968:
        return (
          Utility_replace(
            Utility_replace(
      ...
      case 4068:
      case 2532:
        return Utility_replace(value, /(.+)-inline(.+)/, Enum_WEBKIT + "$1$2") + value; // (min|max)?(width|height|inline-size|block-size)
      case 8116:
      case 7059:
      case 5753:
      case 5535:
      ...
      case 5789:
      case 5021:
      case 4765: // stretch, max-content, min-content, fill-available
        if (Utility_strlen(value) - 1 - length > 6)
          switch (
            Utility_charat(value, length + 1) // (m)ax-content, (m)in-content
          ) {
            case 109: // -
              ...
              return (
                Utility_replace(
                  ...
                  "$1" +
                    ...
                    "$1" +
                    Enum_MOZ +
                    (Utility_charat(value, length + 3) == 108 ? "$3" : "$2-$3"),
                ) + value
              ); // (s)tretch
            case 115:
      ...
      case 6444:
        switch (
          Utility_charat(value, Utility_strlen(value) - 3 - (~indexof(value, "!important") && 10)) // stic(k)y
        ) {
          case 107:
            return Utility_replace(value, ":", ":" + Enum_WEBKIT) + value; // (inline-)?fl(e)x
          case 101:
            return (
              Utility_replace(
                value,
      ...
      case 5936:
        switch (
          Utility_charat(value, length + 11) // vertical-l(r)
        ) {
          case 114:
            return (
              Enum_WEBKIT +
          ...
          case Enum_RULESET:
            if (element.length)
              return Utility_combine(element.props, function (value) {
                switch (
                  Utility_match(value, /(::plac\w+|:read-\w+)/) // :read-(only|write)
                ) {
                  case ":read-only":
                  case ":read-write":
                    return Serializer_serialize(
                  ...
                  case "::placeholder":
                    return Serializer_serialize(
                      [
                        Tokenizer_copy(element, {
                          props: [
                            Utility_replace(value, /:(plac\w+)/, ":" + Enum_WEBKIT + "input-$1"),
                          ],
                        }),
                        Tokenizer_copy(element, {
  ...
  var unitlessKeys = {
    ...
    zIndex: 1,
    zoom: 1,
    WebkitLineClamp: 1, // SVG-related properties
    fillOpacity: 1,
    floodOpacity: 1,
    stopOpacity: 1,
    strokeDasharray: 1,
  ...
  function handleInterpolation(mergedProps, registered, interpolation) {
    ...
    switch (typeof interpolation) {
      ...
      case "object": {
        ...
        if (keyframes.anim === 1) {
          cursor = { name: keyframes.name, styles: keyframes.styles, next: cursor };
  ...
  var _createEmotion = createEmotion({ key: "css" }),
    ...
    cache = _createEmotion.cache; // ./src/autofill/content/components/constants/styles.ts
  const lightTheme = {
    transparent: {
...
`;
  ...
  function scrollbarStyles(theme, color) {
    const thumbColor =
      (color === null || color === void 0 ? void 0 : color.thumb) ||
      styles_themes[theme].secondary["500"];
    const trackColor =
      (color === null || color === void 0 ? void 0 : color.track) ||
  ...
  function AngleDown({ ariaHidden = true, color, disabled, theme }) {
    const shapeColor = disabled
      ? styles_themes[theme].secondary["300"]
      ...
      ${
        passwordChangeUri
          ? AtRiskNotificationFooter({
              ...
              theme,
              passwordChangeUri:
                params === null || params === void 0 ? void 0 : params.passwordChangeUri,
            })
          : E
      }
    </div>
...
`; // ./src/autofill/notification/abstractions/notification-bar.ts
  ...
  function NotificationConfirmationMessage({
    buttonAria,
    buttonText,
    itemName,
    message,
...
`;
  ...
  function NotificationConfirmationBody({
    buttonAria,
    buttonText,
    confirmationMessage,
    error,
...
`; // ./src/autofill/content/components/notification/confirmation/container.ts
  ...
  function NotificationConfirmationContainer({
    error,
    handleCloseNotification,
    handleOpenVault,
    handleOpenTasks,
...
`; // ../../node_modules/signal-polyfill/dist/index.js
  ...
  const SIGNAL_NODE = /* @__PURE__ */ (() => {
    return { ...REACTIVE_NODE, equal: defaultEquals, value: void 0 };
  })();
  ...
  })(Signal || (Signal = {})); // ../../node_modules/@lit-labs/signals/lib/signal-watcher.js
  /**
   * @license
   * Copyright 2023 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ let signal_watcher_i = !1;
  const signal_watcher_s = new Signal.subtle.Watcher(() => {
      signal_watcher_i ||
        ((signal_watcher_i = !0),
        queueMicrotask(() => {
          signal_watcher_i = !1;
          for (const t of signal_watcher_s.getPending()) t.get();
          signal_watcher_s.watch();
        }));
    }),
    signal_watcher_h = Symbol("SignalWatcherBrand"),
    signal_watcher_e = new FinalizationRegistry((i) => {
      i.unwatch(...Signal.subtle.introspectSources(i));
    }),
    signal_watcher_n = new WeakMap();
  function signal_watcher_o(i) {
    return !0 === i[signal_watcher_h]
      ? (console.warn("SignalWatcher should not be applied to the same class more than once."), i)
      : class extends i {
          constructor() {
            (super(...arguments),
              (this._$St = new Map()),
              (this._$So = new t.State(0)),
              (this._$Si = !1));
          }
          _$Sl() {
            var t, i;
          ...
          _$S_() {
            ...
            this._$Su = new t.Computed(() => {
              (this._$So.get(), super.performUpdate());
            });
            const i = (this.h = new t.subtle.Watcher(function () {
              const t = signal_watcher_n.get(this);
              void 0 !== t &&
                (!1 === t._$Si &&
                  (new Set(this.getPending()).has(t._$Su) ? t.requestUpdate() : t._$Sv()),
                this.watch());
            }));
            (signal_watcher_n.set(i, this),
              signal_watcher_e.register(this, i),
              i.watch(this._$Su),
          ...
          _$Sp() {
            ...
            let i = !1;
            (this.h.unwatch(
              ...t.subtle.introspectSources(this.h).filter((t) => {
                var s;
                const h =
                  !0 !==
                  (null === (s = this._$St.get(t)) || void 0 === s ? void 0 : s.manualDispose);
          ...
          updateEffect(i, s) {
            ...
            return (
              ...
              null !== (h = null == s ? void 0 : s.beforeUpdate) && void 0 !== h && h
                ? t.subtle.untrack(() => e.get())
                : this.updateComplete.then(() => t.subtle.untrack(() => e.get())),
              () => {
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */ const { I: directive_helpers_t } = Z,
    directive_helpers_i = (o) => null === o || ("object" != typeof o && "function" != typeof o),
    directive_helpers_n = { HTML: 1, SVG: 2, MATHML: 3 },
    directive_helpers_e = (o, t) => (void 0 === t ? void 0 !== o?._$litType$ : o?._$litType$ === t),
    directive_helpers_l = (o) => null != o?._$litType$?.h,
    directive_helpers_c = (o) => void 0 !== o?._$litDirective$,
    directive_helpers_d = (o) => o?._$litDirective$,
    directive_helpers_f = (o) => void 0 === o.strings,
    directive_helpers_s = () => document.createComment(""),
    directive_helpers_r = (o, i, n) => {
      const e = o._$AA.parentNode,
        l = void 0 === i ? o._$AB : i._$AA;
      if (void 0 === n) {
        const i = e.insertBefore(directive_helpers_s(), l),
          c = e.insertBefore(directive_helpers_s(), l);
    ...
    directive_helpers_v = (o, t, i = o) => (o._$AI(t, i), o),
    directive_helpers_u = {},
    directive_helpers_m = (o, t = directive_helpers_u) => (o._$AH = t),
    directive_helpers_p = (o) => o._$AH,
   ...
   */ const async_directive_s = (i, t) => {
      ...
      for (const i of e) (i._$AO?.(t, !1), async_directive_s(i, t));
      return !0;
    },
    async_directive_o = (i) => {
      let t, e;
  ...
  function async_directive_n(i, t = !1, e = 0) {
    const r = this._$AH,
      h = this._$AN;
    if (void 0 !== h && 0 !== h.size)
      if (t) {
        if (Array.isArray(r))
          for (let i = e; i < r.length; i++) (async_directive_s(r[i], !1), async_directive_o(r[i]));
        else null != r && (async_directive_s(r, !1), async_directive_o(r));
      } else async_directive_s(this, i);
  }
  const async_directive_c = (i) => {
    i.type == directive_t.CHILD && ((i._$AP ??= async_directive_n), (i._$AQ ??= async_directive_h));
  };
  class async_directive_f extends directive_i {
    constructor() {
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */ let watch_o = !1;
  const watch_n = new Signal.subtle.Watcher(async () => {
    watch_o ||
      ((watch_o = !0),
      queueMicrotask(() => {
        watch_o = !1;
        for (const i of watch_n.getPending()) i.get();
        watch_n.watch();
      }));
  });
  class watch_r extends async_directive_f {
    _$S_() {
      var i, t;
      void 0 === this._$Sm &&
  ...
  const watch_h = directive_e(watch_r); // ../../node_modules/lit/html.js
   ...
   */ const html_tag_m =
      ...
      (t, ...m) =>
        o(
          t,
          ...m.map((o) =>
            o instanceof Signal.State || o instanceof Signal.Computed ? watch_h(o) : o,
          ),
        ),
    html_tag_l = html_tag_m(x),
    html_tag_r = html_tag_m(lit_html_b); // ../../node_modules/@lit-labs/signals/index.js
  /**
   * @license
   * Copyright 2023 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ const signals_l = Signal.State,
    signals_o = Signal.Computed,
    signals_r = (l, o) => new Signal.State(l, o),
    signals_i = (l, o) => new t.Computed(l, o); // ./src/autofill/content/components/signals/selected-cipher.ts
  const selected_cipher_selectedCipher = signals_r(null); // ./src/autofill/content/components/cipher/cipher-action.ts
  ...
  function CipherInfoIndicatorIcons({ organizationCategories = [], theme }) {
    ...
    <span class=${cipherInfoIndicatorIconsStyles}>
      ${organizationCategories.map((name) => {
        var _a;
        return (_a = cipherIndicatorIconsMap[name]) === null || _a === void 0
          ? void 0
          : _a.call(cipherIndicatorIconsMap, { color: styles_themes[theme].text.muted, theme });
      })}
    </span>
  `;
  }
...
`; // ./src/autofill/content/components/cipher/cipher-info.ts
  ...
  function CipherInfo({ cipher, theme }) {
    ...
    const hasIndicatorIcons =
      organizationCategories === null || organizationCategories === void 0
        ? void 0
        : organizationCategories.length;
    return x`
    <div>
...
`; // ../../libs/common/src/billing/enums/payment-method-type.enum.ts
  ...
  })(PaymentMethodType || (PaymentMethodType = {})); // ../../libs/common/src/billing/enums/plan-sponsorship-type.enum.ts

  // FIXME: update to use a const object instead of a typescript enum
  // eslint-disable-next-line @bitwarden/platform/no-enums
  var PlanSponsorshipType;
  (function (PlanSponsorshipType) {
    PlanSponsorshipType[(PlanSponsorshipType["FamiliesForEnterprise"] = 0)] =
      "FamiliesForEnterprise";
  })(PlanSponsorshipType || (PlanSponsorshipType = {})); // ../../libs/common/src/billing/enums/plan-type.enum.ts
  ...
  })(PlanType || (PlanType = {})); // ../../libs/common/src/billing/enums/transaction-type.enum.ts
  ...
  })(TransactionType || (TransactionType = {})); // ../../libs/common/src/billing/enums/product-tier-type.enum.ts
  ...
  })(ProductType || (ProductType = {})); // ../../libs/common/src/billing/enums/plan-interval.enum.ts
  ...
  })(PlanInterval || (PlanInterval = {})); // ../../libs/common/src/billing/enums/index.ts
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ const property_o = { attribute: !0, type: String, converter: u, reflect: !1, hasChanged: f },
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */ function state_r(r) {
    return property_n({ ...r, state: !0, attribute: !1 });
...
`; // ./src/autofill/content/components/option-selection/option-items.ts
  ...
  function handleMenuKeyUp(event) {
    ...
    const items = [...event.currentTarget.querySelectorAll('[tabindex="0"]')];
    ...
    event.preventDefault();
    (_a = items[(index + direction + items.length) % items.length]) === null || _a === void 0
      ? void 0
      : _a.focus();
  }
...
`; // ./src/autofill/content/components/option-selection/option-selection.ts
  ...
  var option_selection_metadata =
    (undefined && undefined.__metadata) ||
    function (k, v) {
      if (typeof Reflect === "object" && typeof Reflect.metadata === "function")
        return Reflect.metadata(k, v);
    };
  var option_selection_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  class OptionSelection extends lit_element_i {
    constructor() {
      ...
      this.handleButtonClick = (event) =>
        option_selection_awaiter(this, void 0, void 0, function* () {
          if (EventSecurity.isEventTrusted(event) && !this.disabled) {
            const isOpening = !this.showMenu;
            if (isOpening) {
              if (
                OptionSelection.currentOpenInstance &&
      ...
      this.handleOptionSelection = (selectedOption) => {
        ...
        (_a = this.selectedSignal) === null || _a === void 0
          ? void 0
          : _a.set(selectedOption.value);
        // Any side-effects that should occur from the selection
        (_b = this.handleSelectionUpdate) === null || _b === void 0
          ? void 0
          : _b.call(this, selectedOption.value);
      };
    }
    createRenderRoot() {
      return this;
  ...
  option_selection_decorate(
    [property_n(), option_selection_metadata("design:type", Boolean)],
    OptionSelection.prototype,
    "disabled",
    void 0,
  );
  option_selection_decorate(
    [property_n(), option_selection_metadata("design:type", String)],
    OptionSelection.prototype,
    "id",
    void 0,
  );
  ...
  option_selection_decorate(
    [property_n({ type: Array }), option_selection_metadata("design:type", Array)],
    OptionSelection.prototype,
    "options",
    void 0,
  );
  ...
  option_selection_decorate(
    [property_n({ attribute: false }), option_selection_metadata("design:type", Object)],
    OptionSelection.prototype,
    "selectedSignal",
    void 0,
  );
  option_selection_decorate(
    [state_r(), option_selection_metadata("design:type", Object)],
    OptionSelection.prototype,
    "showMenu",
    void 0,
  );
  option_selection_decorate(
    [state_r(), option_selection_metadata("design:type", Number)],
    OptionSelection.prototype,
    "menuTopOffset",
    void 0,
  );
  option_selection_decorate(
    [state_r(), option_selection_metadata("design:type", Boolean)],
    OptionSelection.prototype,
    "menuIsEndJustified",
    void 0,
  );
  ...
  /* harmony default export */ var option_selection = customElements.define(
  ...
  function ButtonRow({ theme, primaryButton, selectButtons }) {
    ...
    <div class=${buttonRowStyles}>
      ...
      <div class=${optionSelectionsStyles}>
        ${
          selectButtons === null || selectButtons === void 0
            ? void 0
            : selectButtons.map(
...
`; // ./src/autofill/content/components/signals/selected-collection.ts
  ...
  const selectedCollection = signals_r("0"); // ./src/autofill/content/components/signals/selected-folder.ts

  const selected_folder_selectedFolder = signals_r("0"); // ./src/autofill/content/components/signals/selected-vault.ts

  const selected_vault_selectedVault = signals_r("0"); // ./src/autofill/content/components/notification/button-row.ts
  ...
  function NotificationButtonRow({
    ...
    const initialVaultOptions = [...(personalVaultIsAllowed ? [currentUserVaultOption] : [])];
    const vaultOptions = (
    ...
    if (vaultOptions.length === 1) {
      selected_vault_selectedVault === null || selected_vault_selectedVault === void 0
        ? void 0
        : selected_vault_selectedVault.set(vaultOptions[0].value);
      ...
      if (
        ...
        selectedCollection === null || selectedCollection === void 0
          ? void 0
          : selectedCollection.set(collections[0].id);
      }
    }
    return x`
    ${ButtonRow({
...
`; // ./src/autofill/notification/bar.ts
  ...
  function initNotificationBar(message) {
    return bar_awaiter(this, void 0, void 0, function* () {
      ...
      const resolvedTheme = getResolvedTheme(
        theme !== null && theme !== void 0 ? theme : ThemeTypes.Light,
      );
      ...
      if (isVaultLocked) {
        const notificationConfig = Object.assign(Object.assign({}, notificationBarIframeInitData), {
          headerMessage,
        ...
        const UnlockNotification = NotificationContainer(
          Object.assign(Object.assign({}, notificationConfig), { handleSaveAction }),
        );
      ...
      if (notificationBarIframeInitData.type === NotificationTypes.AtRiskPassword) {
        return B(
          AtRiskNotification(
            Object.assign(Object.assign({}, notificationBarIframeInitData), {
      ...
      yield Promise.all([
        ...
        notificationBarIframeInitData = Object.assign(
          Object.assign({}, notificationBarIframeInitData),
          { organizations, folders, ciphers, collections },
        );
      ...
      function handleEditOrUpdateAction(e) {
        ...
        sendSaveCipherMessage(
          selected_cipher_selectedCipher.get(),
          notificationType === NotificationTypes.Add,
        );
      }
    });
    ...
    if (selectedVault.length > 1) {
      openAddEditVaultItemPopout(
        ...
        Object.assign(
          ...
          (selectedFolder === null || selectedFolder === void 0 ? void 0 : selectedFolder.length) >
            1
    ...
    return B(
      NotificationConfirmationContainer(
        Object.assign(Object.assign({}, notificationBarIframeInitData), {
          ...
          headerMessage,
          i18n,
          itemName: itemName !== null && itemName !== void 0 ? itemName : i18n.typeLogin,
          notificationTestId,
          task,
          theme: resolvedTheme,
          type: type,
  ...
  function removeIndividualVault() {
    return Boolean(
      notificationBarIframeInitData === null || notificationBarIframeInitData === void 0
        ? void 0
        : notificationBarIframeInitData.removeIndividualVault,
    );
  }
