/******/ (function () {
  // webpackBootstrap
  /******/ "use strict"; // ../../libs/common/src/platform/services/fido2/fido2-utils.ts
    ...
    static mapCredentialCreationOptions(options, fallbackSupported) {
      ...
      return {
        ...
        authenticatorSelection: {
          requireResidentKey:
            (_a = keyOptions.authenticatorSelection) === null || _a === void 0
              ? void 0
              : _a.requireResidentKey,
          residentKey:
            (_b = keyOptions.authenticatorSelection) === null || _b === void 0
              ? void 0
              : _b.residentKey,
          userVerification:
            (_c = keyOptions.authenticatorSelection) === null || _c === void 0
              ? void 0
              : _c.userVerification,
        },
        ...
        excludeCredentials:
          (_d = keyOptions.excludeCredentials) === null || _d === void 0
            ? void 0
            : _d.map((credential) => ({
    ...
    static mapCredentialRequestOptions(options, fallbackSupported) {
      ...
      return {
        allowedCredentialIds:
          (_b =
            (_a = keyOptions.allowCredentials) === null || _a === void 0
              ? void 0
              : _a.map((c) =>
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          this.broadcastChannel.postMessage(
            Object.assign(Object.assign({}, request), { SENDER, senderId: this.messengerId }),
            remotePort,
          );
    ...
    createMessageEventListener() {
      return (event) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (
            (message === null || message === void 0 ? void 0 : message.SENDER) !== SENDER ||
  ...
  (function (globalContext) {
    var _a;
    if (
      (_a = globalContext.document.currentScript) === null || _a === void 0 ? void 0 : _a.parentNode
    ) {
    ...
    if (!browserNativeWebauthnSupport) {
      ...
      try {
        ...
        globalContext.AuthenticatorAttestationResponse = class PolyfillAuthenticatorAttestationResponse {};
      } catch (_b) {
        /* empty */
      }
    } else {
    ...
    function createWebAuthnCredential(options) {
      return fido2_page_script_awaiter(this, void 0, void 0, function* () {
        ...
        const authenticatorAttachmentIsPlatform =
          ((_b =
            (_a = options === null || options === void 0 ? void 0 : options.publicKey) === null ||
            _a === void 0
              ? void 0
              : _a.authenticatorSelection) === null || _b === void 0
            ? void 0
            : _b.authenticatorAttachment) === "platform";
        const fallbackSupported =
          (authenticatorAttachmentIsPlatform &&
    ...
    function getWebAuthnCredential(options) {
      return fido2_page_script_awaiter(this, void 0, void 0, function* () {
        ...
        if (
          (options === null || options === void 0 ? void 0 : options.mediation) &&
          options.mediation === "conditional"
        ) {
          const internalAbortControllers = [new AbortController(), new AbortController()];
          const bitwardenResponse = (internalAbortController) =>
            fido2_page_script_awaiter(this, void 0, void 0, function* () {
              try {
                const abortListener = () =>
                  messenger.request({
                    type: MessageTypes.AbortRequest,
          ...
          const browserResponse = (internalAbortController) =>
            browserCredentials.get(
              Object.assign(Object.assign({}, options), { signal: internalAbortController.signal }),
            );
          const abortListener = () => {
    ...
    function waitForFocus() {
      return fido2_page_script_awaiter(
        this,
        arguments,
        void 0,
        function* (fallbackWait = 500, timeout = 5 * 60 * 1000) {
          var _a;
          try {
            if (
              (_a = globalContext.top) === null || _a === void 0 ? void 0 : _a.document.hasFocus()
            ) {
              return;
            }
          } catch (_b) {
    ...
    function clearWaitForFocus() {
      var _a;
      (_a = globalContext.top) === null || _a === void 0
        ? void 0
        : _a.removeEventListener("focus", focusListenerHandler);
