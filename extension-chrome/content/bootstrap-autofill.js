/******/ (function () {
  // webpackBootstrap
  /******/ "use strict"; // ./src/autofill/services/dom-element-visibility.service.ts
  ...
  /* harmony default export */ var dom_element_visibility_service = DomElementVisibilityService; // ../../libs/common/src/autofill/constants/match-patterns.ts
  ...
  const MAX_DEEP_QUERY_RECURSION_DEPTH = 4; // ./src/autofill/enums/autofill-port.enum.ts
  ...
  /* harmony default export */ var insert_autofill_content_service = InsertAutofillContentService; // ./src/autofill/content/autofill-init.ts

  var autofill_init_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  class AutofillInit {
    ...
    constructor(
      ...
      this.insertAutofillContentService = new insert_autofill_content_service(
        domElementVisibilityService,
    ...
    collectPageDetails(message_1) {
      return autofill_init_awaiter(
        this,
        arguments,
        void 0,
        function* (message, sendDetailsInResponse = false) {
    ...
    fillForm(_a) {
      return autofill_init_awaiter(
        ...
        arguments,
        void 0,
        function* ({ fillScript, pageDetailsUrl }) {
    ...
    blurFocusedFieldAndCloseInlineMenu() {
      ...
      (_a = this.autofillOverlayContentService) === null || _a === void 0
        ? void 0
        : _a.blurMostRecentlyFocusedField(true);
    }
    /**
    ...
    getExtensionMessageHandler(command) {
      ...
      if (
        (_d =
          (_c = this.autofillInlineMenuContentService) === null || _c === void 0
            ? void 0
            : _c.messageHandlers) === null || _d === void 0
          ? void 0
          : _d[command]
      ) {
      ...
      if (
        (_f =
          (_e = this.overlayNotificationsContentService) === null || _e === void 0
            ? void 0
            : _e.messageHandlers) === null || _f === void 0
          ? void 0
          : _f[command]
      ) {
    ...
    destroy() {
      ...
      (_b = this.autofillInlineMenuContentService) === null || _b === void 0
        ? void 0
        : _b.destroy();
      (_c = this.overlayNotificationsContentService) === null || _c === void 0
        ? void 0
        : _c.destroy();
    }
  }
  /* harmony default export */ var autofill_init = AutofillInit; // ./src/autofill/content/bootstrap-autofill.ts
