/******/ (function () {
  // webpackBootstrap
  /******/ "use strict"; // ../../libs/common/src/autofill/constants/match-patterns.ts
  ...
  const MAX_DEEP_QUERY_RECURSION_DEPTH = 4; // ./src/autofill/services/autofill-constants.ts
  ...
  AutoFillConstants.NewEmailFieldKeywords = ["new-email", "newemail", "new email", "neue e-mail"];
  AutoFillConstants.RegistrationKeywords = ["register", "signup", "sign-up", "join", "create"];
  ...
  const SubmitLoginButtonNames = ["login", "signin", "submit", "continue", "next", "verify"];
  ...
  var collect_autofill_content_service_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  class CollectAutofillContentService {
    constructor(domElementVisibilityService, domQueryService, autofillOverlayContentService) {
       ...
       */
      this.buildAutofillFieldItem = (element, index) =>
        collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
          var _a;
          ...
          const autofillField = Object.assign(
            Object.assign(Object.assign({}, autofillFieldBase), autofillFieldLabels),
            {
              ...
              "aria-hidden": this.getAttributeBoolean(
                element,
                AUTOFILL_ATTRIBUTES.ARIA_HIDDEN,
                true,
              ),
              "aria-disabled": this.getAttributeBoolean(
                element,
                AUTOFILL_ATTRIBUTES.ARIA_DISABLED,
                true,
              ),
              "aria-haspopup": this.getAttributeBoolean(
                element,
      ...
      this.setupInitialTopLayerListeners = () => {
        var _a;
        const unownedTopLayerItems =
          (_a = this.autofillOverlayContentService) === null || _a === void 0
            ? void 0
            : _a.getUnownedTopLayerItems(true);
        if (
          unownedTopLayerItems === null || unownedTopLayerItems === void 0
            ? void 0
            : unownedTopLayerItems.length
        ) {
      ...
      this.handleMutationObserverMutation = (mutations) => {
        ...
        const hasMutationsInShadowRoot =
      ...
      this.handleTopLayerChanges = (mutation) => {
        ...
        if (
          ...
          ((_a = mutation.addedNodes) === null || _a === void 0 ? void 0 : _a.length) > 0
        ) {
       ...
       */
      this.handleFormElementIntersection = (entries) =>
        collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
          var _a;
          for (let entryIndex = 0; entryIndex < entries.length; entryIndex++) {
            ...
            const isViewable =
              yield this.domElementVisibilityService.isElementViewable(formFieldElement);
            if (!isViewable) {
              continue;
            }
    ...
    getPageDetails() {
      return collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
        ...
        const autofillFieldsData = (yield this.buildAutofillFieldsData(formFieldElements)).filter(
          (field) => !!field,
        );
    ...
    getAutofillFieldElementByOpid(opid) {
      ...
      const formFieldElements = (
        cachedFormFieldElements === null || cachedFormFieldElements === void 0
          ? void 0
          : cachedFormFieldElements.length
      )
        ? cachedFormFieldElements
        : this.getAutofillFieldElements();
      const fieldElementsWithOpid = formFieldElements.filter(
        (fieldElement) => fieldElement.opid === opid,
      );
    ...
    updateCachedAutofillFieldVisibility() {
      this.autofillFieldElements.forEach((autofillField, element) =>
        collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
          const previouslyViewable = autofillField.viewable;
          autofillField.viewable =
            yield this.domElementVisibilityService.isElementViewable(element);
    ...
    getAutofillFieldElements(fieldsLimit, previouslyFoundFormFieldElements) {
      ...
      if (!formFieldElements) {
        formFieldElements = this.domQueryService.query(
          globalThis.document.documentElement,
          this.formFieldQueryString,
          (node) => this.isNodeFormFieldElement(node),
      ...
      for (const element of formFieldElements) {
        ...
        const fieldType =
          (_a = this.getPropertyOrAttribute(element, AUTOFILL_ATTRIBUTES.TYPE)) === null ||
          _a === void 0
            ? void 0
            : _a.toLowerCase();
    ...
    getAttributeLowerCase(element, attributeName) {
      var _a;
      return (_a = this.getPropertyOrAttribute(element, attributeName)) === null || _a === void 0
        ? void 0
        : _a.toLowerCase();
    }
    /**
    ...
    createAutofillFieldLabelTag(element) {
      ...
      for (
        let labelIndex = 0;
        labelIndex <
        (labelElements === null || labelElements === void 0 ? void 0 : labelElements.length);
        labelIndex++
      ) {
    ...
    createAutofillFieldTopLabel(element) {
      ...
      const parentSiblingTableRowElement =
        (_a = tableDataElement.closest("tr")) === null || _a === void 0
          ? void 0
          : _a.previousElementSibling;
      return ((_b =
        parentSiblingTableRowElement === null || parentSiblingTableRowElement === void 0
          ? void 0
          : parentSiblingTableRowElement.cells) === null || _b === void 0
        ? void 0
        : _b.length) > tableDataElementIndex
    ...
    recursivelyGetTextFromPreviousSiblings(element) {
      ...
      while (
        (siblingElement === null || siblingElement === void 0
          ? void 0
    ...
    queryAutofillFormAndFieldElements() {
      const formElements = [];
      const formFieldElements = [];
      const queriedElements = this.domQueryService.query(
        globalThis.document.documentElement,
    ...
    isNodeFormFieldElement(node) {
      ...
      const nodeIsValidInputElement =
        nodeTagName === "input" && !this.ignoredInputTypes.has(node.type);
    ...
    isAutofillElementNodeMutated(nodes, isRemovingNodes = false) {
      ...
      for (let index = 0; index < nodes.length; index++) {
        ...
        const autofillElements = this.domQueryService.query(
          node,
          `form, ${this.formFieldQueryString}`,
          (walkerNode) => nodeIsFormElement(walkerNode) || this.isNodeFormFieldElement(walkerNode),
          this.mutationObserver,
          true,
        );
    ...
    setupOverlayListenersOnMutatedElements(mutatedElements) {
      for (let elementIndex = 0; elementIndex < mutatedElements.length; elementIndex++) {
        ...
        const buildAutofillFieldItem = () =>
          collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
            if (!this.isNodeFormFieldElement(node) || this.autofillFieldElements.get(node)) {
              return;
            }
    ...
    deleteCachedAutofillElement(element) {
      ...
      if (this.autofillFieldElements.has(element)) {
        ...
        if (
          autofillFieldData === null || autofillFieldData === void 0
            ? void 0
    ...
    handleAutofillElementAttributeMutation(mutation) {
      ...
      const attributeName =
        (_a = mutation.attributeName) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    ...
    updateAutofillFieldElementData(attributeName, element, dataTarget) {
      ...
      const updateActions = {
        ...
        type: () =>
          (dataTarget.type = this.getAttributeLowerCase(element, AUTOFILL_ATTRIBUTES.TYPE)),
      };
      if (!updateActions[attributeName]) {
        return;
      }
    ...
    isPasswordFieldWithinDocument() {
      var _a;
      return (
        ((_a = this.domQueryService.query(
          globalThis.document.documentElement,
          `input[type="password"]`,
          (node) => nodeIsInputElement(node) && node.type === "password",
        )) === null || _a === void 0
          ? void 0
          : _a.length) > 0
      );
  ...
  var dom_element_visibility_service_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  class DomElementVisibilityService {
    ...
    formFieldIsNotHiddenBehindAnotherElement(
      targetElement,
      targetElementBoundingClientRect = null,
    ) {
      var _a, _b;
      const elementBoundingClientRect =
        targetElementBoundingClientRect || targetElement.getBoundingClientRect();
      ...
      if (
        (_a = this.inlineMenuContentService) === null || _a === void 0
          ? void 0
          : _a.isElementInlineMenu(elementAtCenterPoint)
      ) {
        return true;
      }
      ...
      const closestParentLabel =
        (_b =
          elementAtCenterPoint === null || elementAtCenterPoint === void 0
            ? void 0
            : elementAtCenterPoint.parentElement) === null || _b === void 0
          ? void 0
          : _b.closest("label");
      return closestParentLabel ? targetElementLabelsSet.has(closestParentLabel) : false;
    }
  }
  /* harmony default export */ var dom_element_visibility_service = DomElementVisibilityService; // ./src/autofill/services/dom-query.service.ts

  var dom_query_service_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
    ...
    constructor() {
      ...
      this.updatePageContainsShadowDom = () => {
        this.pageContainsShadowDom =
          this.queryShadowRoots(globalThis.document.body, true).length > 0;
    ...
    buildTreeWalkerNodesQueryResults(
      ...
      const treeWalker =
        document === null || document === void 0
          ? void 0
          : document.createTreeWalker(rootNode, NodeFilter.SHOW_ELEMENT, (node) => {
              var _a;
              return ignoredTreeWalkerNodes.has(
                (_a = node.nodeName) === null || _a === void 0 ? void 0 : _a.toLowerCase(),
              )
                ? NodeFilter.FILTER_REJECT
                : NodeFilter.FILTER_ACCEPT;
            });
      let currentNode =
        treeWalker === null || treeWalker === void 0 ? void 0 : treeWalker.currentNode;
      while (currentNode) {
  ...
  var insert_autofill_content_service_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  class InsertAutofillContentService {
    ...
    constructor(domElementVisibilityService, collectAutofillContentService) {
      ...
      this.runFillScriptAction = ([action, opid, value]) => {
        ...
        return new Promise((resolve) =>
          setTimeout(() => {
            if (
              action === FillScriptActionTypes.fill_by_opid &&
    ...
    fillForm(fillScript) {
      return insert_autofill_content_service_awaiter(this, void 0, void 0, function* () {
        var _a;
        if (
          !((_a = fillScript.script) === null || _a === void 0 ? void 0 : _a.length) ||
    ...
    userCancelledInsecureUrlAutofill(savedUrls) {
      if (
        !(savedUrls === null || savedUrls === void 0
          ? void 0
    ...
    insertValueIntoField(element, value) {
      ...
      const elementValue =
        ...
        (element === null || element === void 0 ? void 0 : element.innerText) ||
        "";
      const elementAlreadyHasTheValue = !!(
        (elementValue === null || elementValue === void 0 ? void 0 : elementValue.length) &&
        elementValue === value
      );
      if (
  ...
  /* harmony default export */ var insert_autofill_content_service = InsertAutofillContentService; // ./src/autofill/content/auto-submit-login.ts

  var auto_submit_login_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  (function (globalContext) {
    ...
    const insertAutofillContentService = new insert_autofill_content_service(
      domElementVisibilityService,
    ...
    function startAutoSubmitLoginWorkflow() {
      return auto_submit_login_awaiter(this, void 0, void 0, function* () {
        ...
        if (
          !(pageDetails === null || pageDetails === void 0 ? void 0 : pageDetails.fields.length)
        ) {
    ...
    function handleExtensionMessage(_a) {
      return auto_submit_login_awaiter(
        this,
        arguments,
        void 0,
        function* ({ command, fillScript, pageDetailsUrl }) {
          if (
    ...
    function triggerAutoSubmitLogin(fillScript) {
      return auto_submit_login_awaiter(this, void 0, void 0, function* () {
        var _a;
        if (
          !((_a = fillScript === null || fillScript === void 0 ? void 0 : fillScript.autosubmit) ===
            null || _a === void 0
            ? void 0
            : _a.length)
        ) {
    ...
    function submitElementFoundAndClicked(element, lastFieldIsPasswordInput = false) {
      const genericSubmitElement = querySubmitButtonElement(element, "[type='submit']", (node) =>
      ...
      const buttonElement = querySubmitButtonElement(element, "button, [type='button']", (node) =>
    ...
    function getAutofillFormElementByOpid(opid) {
      ...
      const formElements = (
        cachedFormElements === null || cachedFormElements === void 0
          ? void 0
          : cachedFormElements.length
      )
        ? cachedFormElements
    ...
    function getAutofillFormElements() {
      return domQueryService.query(globalContext.document.documentElement, "form", (node) =>
        nodeIsFormElement(node),
      );
    }
    /**
    ...
    function setAutoSubmitLoginTimeout(delay) {
      clearAutoSubmitLoginTimeout();
      autoSubmitLoginTimeout = globalContext.setTimeout(
        () => startAutoSubmitLoginWorkflow(),
        delay,
      );
    }
    /**
