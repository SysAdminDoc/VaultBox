/******/ (function () {
  // webpackBootstrap
  /******/ "use strict"; // ./src/autofill/enums/autofill-port.enum.ts
  ...
  class Messenger {
    ...
    createMessageEventListener() {
      return (event) =>
        messenger_awaiter(this, void 0, void 0, function* () {
          var _a;
          const windowOrigin = window.location.origin;
  ...
  var fido2_content_script_awaiter =
    (undefined && undefined.__awaiter) ||
    function (thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P
  ...
  (function (globalContext) {
    ...
    function respondToCredentialRequest(command, type, requestId, messageData) {
      return fido2_content_script_awaiter(this, void 0, void 0, function* () {
        const data = Object.assign(Object.assign({}, messageData), {
